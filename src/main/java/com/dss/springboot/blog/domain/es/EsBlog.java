package com.dss.springboot.blog.domain.es;
...
public class EsBlog implements Serializable {
	...
	private static final long serialVersionUID = 1485222447472048130L;
	...
	private Long readSize = (long) 0; // 访问量、阅读量
	private Long commentSize = (long) 0; // 评论量
	private Long voteSize = (long) 0; // 点赞量
	...
	public EsBlog(Long blogId, String title, String summary, String content, String username, String avatar,
			Timestamp createTime, Long readSize, Long commentSize, Long voteSize, String tags) {
		this.blogId = blogId;
		this.title = title;
	...
	public String toString() {
		return "EsBlog [id=" + id + ", blogId=" + blogId + ", title=" + title + ", summary=" + summary + ", content="
				+ content + ", tags=" + tags + ", username=" + username + ", avatar=" + avatar + ", createTime="
				+ createTime + ", readSize=" + readSize + ", commentSize=" + commentSize + ", voteSize=" + voteSize
				+ "]";
	}
